...
· 跟随主题：原生适配深浅双色，全天候护眼。
· 真正轻量：除相机权限外不申请任何敏感权限，无广告、无埋点、无追踪、无后台联网。
...
Rotor 严格遵循"最小权限原则"，全应用仅申请 **1 项** 系统权限，另声明 **1 项** 不向用户申请授权的系统备份扩展能力。
...
└── 05_privacy.svg  05_privacy.png   隐私本地（深色品牌）
```
